...
class FlappyBirdUI:
    ...
    def update(self, birds: list[Bird], scored: bool) -> None:
        ...
        self._surface_birds_alive = self._create_surface_birds_alive(birds)
    ...
    def _create_surface_birds_alive(self, birds: list[Bird]) -> pg.Surface:
        """Atualiza o Surface do número de pássaros vivos."""
        return self._font.render(str(len(tuple(filter(lambda b: b.is_alive, birds)))), True, (255, 255, 255))

    def __repr__(self) -> str:
        return f'FlappyBirdUI(score={self.score})'
